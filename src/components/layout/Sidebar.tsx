...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  return (
    <aside
      ...
      } lg:translate-x-0 fixed lg:sticky lg:top-[50px] lg:h-[calc(100vh-50px)] top-[50px] inset-y-0 left-0 z-40 w-57 bg-white border-r border-gray-300 transition-transform duration-300 ease-in-out`}
    >
